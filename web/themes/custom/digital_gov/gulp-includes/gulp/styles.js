...
const USWDS_SRC = "./css/new/uswds";

// Project Sass source directory
const PROJECT_SASS_SRC = "./css/new";

// Images destination
const IMG_DEST = "./static/uswds/img";

// Fonts destination
const FONTS_DEST = "./static/uswds/fonts";

// Compiled CSS destination
const CSS_DEST = "./static/dist";
